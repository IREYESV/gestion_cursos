...
async function agregar_cursos(nombre, nivel_tecnico, fecha_inicio,duracion) {
    let client
    try {
    ...
    let res = await client.query({
        ...
        values:[nombre, nivel_tecnico, fecha_inicio,duracion]
    })
...
async function hacer_transferencia(emisor_nombre, receptor_nombre, monto_transferencia) {
    ...
    let res3 = await client.query({
        text: "insert into curso (emisor, receptor, monto ) values ($1, $2, $3)",
